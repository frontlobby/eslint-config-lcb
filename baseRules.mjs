...
/**
 * Base rules for FrontLobby projects including this one.
 */
const rules = {
	// Possible Errors
	...
	'@typescript-eslint/no-restricted-types'          : [ 'warn', {
		types : {
			...
			'Function' : { message : 'Prefer explicitly defining the function shape instead of using Function.' },
			'Object'   : { message : 'Prefer object or unknown based on the value shape you actually need.' },
			'{}'       : { message : 'Prefer object or unknown based on the value shape you actually need.' },
		},
	} ],
...
export const config = [
	...
	{
		name            : '@frontlobby/eslint-config-lcb/base',
		languageOptions : {
